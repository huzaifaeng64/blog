...
ActiveRecord::Schema.define(version: 2019_10_11_084542) do
  ...
  create_table "platform_products", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.integer "status"
    t.index ["brand_id"], name: "index_platform_products_on_brand_id"
  ...
  add_foreign_key "platform_products", "brands"
